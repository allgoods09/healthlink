...
@section('title', $pageTitle ?? 'Sync Log Details - HealthLink Admin')
@section('header', $pageHeader ?? 'Sync Log Details')
...
@section('actions')
    <a href="{{ route($routePrefix.'.sync-logs.index', request()->query()) }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-md hover:bg-gray-200">
