...
@section('title', $pageTitle ?? 'Purok Details - HealthLink Admin')
@section('header', $pageHeader ?? 'Purok Details')
...
@section('actions')
    <div class="flex items-center space-x-2">
        ...
        <a href="{{ route($routePrefix.'.puroks.edit', $purok) }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700">
            Edit Purok
        </a>
    </div>
@endsection
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="px-6 py-4 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
                    ...
                    <a href="{{ route($routePrefix.'.households.create', ['purok_id' => $purok->id, 'barangay_id' => $purok->barangay_id]) }}" class="text-sm text-blue-600 hover:text-blue-900">
                        + Add Household
                    </a>
                </div>
                <div class="p-6">
                                ...
                                <li class="py-3">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <a href="{{ route($routePrefix.'.households.show', $household) }}" class="text-blue-600 hover:text-blue-900 text-sm">View</a>
                                        </div>
                                    </div>
                                </li>
                            @endforeach
                            ...
                            @foreach($bhws as $bhw)
                                <li class="py-3">
                                    <div class="flex items-center justify-between">
                                        ...
                                        @else
                                            <span class="text-sm text-gray-500">BHW account</span>
                                        @endif
                                    </div>
                                </li>
                            @endforeach
