...
@section('title', 'Create Barangay - HealthLink Admin')
@section('header', 'Create New Barangay')
            ...
            <form method="POST" action="{{ route('admin.barangays.store') }}">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="psgc_code" id="psgc_code" value="{{ old('psgc_code') }}" 
                    ...
                    <div>
                        ...
                        <input type="text" name="municipality" id="municipality" value="{{ old('municipality', 'Tubigon') }}" 
                    ...
                    <div>
                        ...
                        <input type="text" name="province" id="province" value="{{ old('province', 'Bohol') }}" 
                    ...
                    <div>
                        ...
                        <input type="text" name="region" id="region" value="{{ old('region', 'VII') }}" 
                ...
                @include('admin.geometry.barangays._official-fields')
