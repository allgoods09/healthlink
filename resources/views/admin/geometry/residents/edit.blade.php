...
@section('title', $pageTitle ?? 'Edit Resident - HealthLink Admin')
@section('header', $pageHeader ?? 'Edit Resident')
...
@section('actions')
    <div class="flex items-center gap-2">
        <a href="{{ route($routePrefix.'.residents.show', $resident) }}" class="inline-flex items-center rounded-md bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200">
            View
        </a>
...
@section('content')
    <div class="rounded-lg bg-white shadow">
        <div class="p-6">
            <form
                method="POST"
                action="{{ route($routePrefix.'.residents.update', $resident) }}"
                x-data="residentForm(
